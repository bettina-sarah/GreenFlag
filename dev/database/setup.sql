...
VALUES
('John', 'Doe', 'password123', 'john.doe1@example.com', '1990-05-12', 'Male'::GENDER, ARRAY['Female', 'Non-Binary']::GENDER[], 20, 35, 'Long term'::RELATIONSHIP, 180, NULL, TRUE, 'New York', 'token12345', TRUE, TRUE),
('Jane', 'Smith', 'password123', 'jane.smith2@example.com', '1988-11-22', 'Female'::GENDER, ARRAY['Male']::GENDER[], 25, 40, 'Short term'::RELATIONSHIP, 165, NULL, FALSE, 'Los Angeles', 'token12346', FALSE, TRUE),
...
('Michael', 'Johnson', 'password123', 'michael.johnson4@example.com', '1982-09-08', 'Male'::GENDER, ARRAY['Female', 'Other']::GENDER[], 28, 50, 'Long term'::RELATIONSHIP, 175, NULL, TRUE, 'Houston', 'token12348', FALSE, TRUE),
('Emily', 'Davis', 'password123', 'emily.davis5@example.com', '1993-04-30', 'Female'::GENDER, ARRAY['Male']::GENDER[], 22, 45, 'Long term'::RELATIONSHIP, 160, NULL, TRUE, 'Phoenix', 'token12349', TRUE, TRUE),
('David', 'Miller', 'password123', 'david.miller6@example.com', '1978-12-14', 'Male'::GENDER, ARRAY['Non-Binary']::GENDER[], 30, 55, 'Short term'::RELATIONSHIP, 190, NULL, FALSE, 'Philadelphia', 'token12350', FALSE, TRUE),
...
('James', 'Moore', 'password123', 'james.moore8@example.com', '1985-07-25', 'Male'::GENDER, ARRAY['Female', 'Other']::GENDER[], 26, 38, 'Short term'::RELATIONSHIP, 185, NULL, FALSE, 'San Diego', 'token12352', FALSE, TRUE),
('Olivia', 'Taylor', 'password123', 'olivia.taylor9@example.com', '1990-02-03', 'Female'::GENDER, ARRAY['Male']::GENDER[], 24, 50, 'Long term'::RELATIONSHIP, 168, NULL, TRUE, 'Dallas', 'token12353', TRUE, TRUE),
...
('Emma', 'Thomas', 'password123', 'emma.thomas11@example.com', '1996-05-21', 'Female'::GENDER, ARRAY['Male']::GENDER[], 23, 39, 'Long term'::RELATIONSHIP, 162, NULL, FALSE, 'Austin', 'token12355', TRUE, TRUE),
('Christopher', 'Jackson', 'password123', 'christopher.jackson12@example.com', '1977-01-12', 'Male'::GENDER, ARRAY['Female']::GENDER[], 31, 60, 'Short term'::RELATIONSHIP, 195, NULL, TRUE, 'Jacksonville', 'token12356', FALSE, TRUE),
...
('Matthew', 'Harris', 'password123', 'matthew.harris14@example.com', '1980-03-02', 'Male'::GENDER, ARRAY['Male']::GENDER[], 29, 48, 'Long term'::RELATIONSHIP, 178, NULL, TRUE, 'Columbus', 'token12358', FALSE, TRUE),
('Ava', 'Martin', 'password123', 'ava.martin15@example.com', '1991-07-13', 'Female'::GENDER, ARRAY['Female']::GENDER[], 19, 33, 'Short term'::RELATIONSHIP, 158, NULL, TRUE, 'Fort Worth', 'token12359', TRUE, TRUE),
...
('Mia', 'Martinez', 'password123', 'mia.martinez17@example.com', '1992-10-05', 'Female'::GENDER, ARRAY['Female']::GENDER[], 24, 41, 'Long term'::RELATIONSHIP, 161, NULL, TRUE, 'Charlotte', 'token12361', TRUE, TRUE),
('Joshua', 'Rodriguez', 'password123', 'joshua.rodriguez18@example.com', '1987-02-15', 'Male'::GENDER, ARRAY['Female', 'Non-Binary']::GENDER[], 26, 50, 'Short term'::RELATIONSHIP, 188, NULL, FALSE, 'Seattle', 'token12362', FALSE, TRUE),
...
('Ethan', 'Gonzalez', 'password123', 'ethan.gonzalez20@example.com', '1983-12-07', 'Male'::GENDER, ARRAY['Male']::GENDER[], 30, 55, 'Long term'::RELATIONSHIP, 183, NULL, TRUE, 'Washington', 'token12364', FALSE, TRUE);
