...
const CreateAccount: React.FC = () => (
  <div className="relative w-full h-full flex flex-col items-center justify-between bg-home-bg2 bg-cover bg-center">
    <div className="absolute top-2 left-2">
      <IconButton icon={BackArrowIcon} page=" " className="p-2" />
    </div>
    <h1
      className="text-5xl font-bold text-text-base font-leckerli"
      style={{ transform: "translateY(30vh) rotate(-18deg)" }}
    >
      Create Account
    </h1>
